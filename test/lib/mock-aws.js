...
exports.uploadMock = {
  ...
  Location: 'https://gca-backend-assets.s3.amazonaws.com/cd52be0bc15dd9500e87d9afcf35c19e.png',
  key: 'cd52be0bc15dd9500e87d9afcf35c19e.png',
  Key: 'cd52be0bc15dd9500e87d9afcf35c19e.png',
  Bucket: 'gca-backend-assets',
};
...
AWSMock.mock('S3', 'upload', function(params, callback) {
  ...
  if(params.Bucket !== process.env.AWS_BUCKET)
    return callback(new Error('Bucket must be gca-backend-assets'));
  if(!params.Key)
